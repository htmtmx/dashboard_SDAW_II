        ...
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
            ...
            <div class="flex items-center lg:order-2">
                @if (Route::has('login'))
                    ...
                    @else
                        <a href="{{ route('login') }}"
                            class="text-gray-800 dark:text-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">
                            {{ __('Log in') }}
                        </a>
            ...
            <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    <li>
                        <a href="{{ route('home') }}"
                            class="block py-2 pl-3 pr-4 text-white rounded lg:bg-transparent {{ request()->is('/') ? 'lg:text-purple-700' : '' }}  lg:p-0 dark:text-white"
                            aria-current="page">
                            {{ __('Home') }}
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#"
                            class="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">{{ __('Team') }}</a>
                    </li>
                </ul>
            </div>
        </div>
